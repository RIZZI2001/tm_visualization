...
const optionsTabs = {
    ...
    Coloring: ['topicColorScale', 'topicColorScaleType', 'metadataColorScale', 'metadataColorScaleType', 'otuColorScale', 'otuColorScaleType', 'invertColorScale', 'topicColorScaleForce 0-1', 'otuColorScaleForce 0-1'],
